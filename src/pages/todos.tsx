...
export default function Todos() {
  ...
  return (
    <>
      <Head>
        <title>JSI | Todo List</title>
        <meta name="description" content="Manage your tasks easily" />
      </Head>

      <main
        className={`min-h-screen p-6 transition-opacity duration-500 bg-gradient-to-b from-purple-600 via-purple-500 to-purple-400 ${
      ...
      >
        ...
        <div className="flex justify-center mt-6">
          <Link href="/">
            <span className="px-6 py-3 bg-white text-purple-700 font-bold rounded-lg shadow-md transition hover:bg-purple-100 hover:shadow-lg cursor-pointer">
              Back to Homepage
            </span>
          </Link>
        </div>
